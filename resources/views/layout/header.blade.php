    ...
    <div class="content-header">
        ...
        <div class="content-header-section">
            ...
            <div class="btn-group d-md-none">
                <img src="{{asset("minahasa.png")}}" alt="">
            </div>
            <!-- Open Search Section -->
            <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
            <button hidden type="button" class="btn btn-circle btn-dual-secondary" data-toggle="layout" data-action="header_search_on">
        ...
        <div class="content-header-section">
            ...
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-sm-inline-block">{{session('name')}}</span>
            ...
            <!-- Toggle Side Overlay -->
            <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
            <button hidden type="button" class="btn btn-circle btn-dual-secondary" data-toggle="layout" data-action="side_overlay_toggle">
