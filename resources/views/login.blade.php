...
<head>
    ...
    <title>Login Pariwisata Minahasa</title>

    <meta name="description"
        content="Dinas Pariwisata dan Kebudayaan Minahasa">
    <meta name="author" content="Dinas Pariwisata dan Kebudayaan Minahasa">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="Dinas Pariwisata dan Kebudayaan Minahasa">
    <meta property="og:site_name" content="Dinas Pariwisata dan Kebudayaan Minahasa">
    ...
    <link rel="stylesheet" href="//fonts.googleapis.com/css?family=Muli:300,400,400i,600,700">
...
<body>
    ...
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            ...
            <!-- Page Content -->
            <div class="bg-image" style="background-image: url('assets/login.jpg');">
                <div class="row mx-0 bg-black-op">
                    ...
                    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible"
                        ...
                        <div class="content content-full">
                            ...
                            <form class="js-validation-signin px-30" action="{{ route('logincheck') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-sm btn-hero btn-alt-secondary" href="{{route('dashboard')}}">Kembali</a>
                                    <div class="mt-30">
