                ...
                @foreach ($wisata as $row)
                    <div class="mb-50">
                        <a href="{{ route('dashboard/detailwisata', $row->id) }}">
                            <h3 class="h4 font-w700 mb-5">{{ $row->nama_lokasi }}</h3>
                        </a>
                        <div class="text-muted mb-10">
                            <span class="mr-15">
                                <i class="fa fa-fw fa-calendar mr-5"></i>Di input pada {{ $row->created_at }}
                            </span>
                            <a class="text-muted mr-15" href="#">
                                <i class="fa fa-fw fa-user mr-5"></i>Oleh Admin
                            </a>
                        </div>
                        <div class="overflow-hidden rounded mb-20" style="height: 300px;" hidden>
                            <div class="mapouter">
                                <div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0"
                                        scrolling="no" marginheight="0" marginwidth="0"
                                        src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q={{ $row->garis_lintang }},{{ $row->garis_bujur }}&amp;t=k&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a
                        ...
                        <img style="width: 100%; border-radius: 15px" class="img-fluid" loading="lazy"
                            src="{{ asset('') . $row->gambar }}" alt="{{ $row->gambar }}">
                        <p><?= substr($row->informasi, 0, 300) ?>...
